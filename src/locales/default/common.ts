export default {
  ...
  branching: '创建子话题',
  branchingDisable:
    'Sub-topic feature is not available in the current mode. To use this feature, please switch to Postgres/Pglite DB mode or use GenHub Cloud',
  cancel: '取消',
  changelog: '更新日志',
  clientDB: {
    autoInit: {
  ...
  telemetry: {
    allow: '继续使用',
    deny: '关闭数据收集',
    desc: '我们正在匿名收集你的使用信息，以帮助我们改进 {{appName}} 并为你提供更好的产品体验。你可以随时在「设置」 - 「关于」中关闭此功能。',
    learnMore: '了解更多',
    title: '{{appName}} 正在收集匿名使用数据',
  },
  temp: '临时',
  terms: '服务条款',
  update: '更新',
